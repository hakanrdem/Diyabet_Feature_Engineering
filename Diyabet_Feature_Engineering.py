...
tutulan büyük veri setinin parçasıdır. ABD'deki Arizona Eyaleti'nin en büyük 5. şehri olan
Phoenix şehrinde yaşayan 21 yaş ve üzerinde olan Pima Indian kadınları üzerinde yapılan 
diyabet araştırması için kullanılan verilerdir.
...
df = pd.read_csv("dsmlbc_9_abdulkadir/Homeworks/hakan_erdem/5_Özellik_Mühendisliği/Diyabet_Feature_Engineering/diabetes.csv")
df.head()
...
# Veri setinde eksik gözlem bulunmamakta ama Glikoz,
# Insulin vb. değişkenlerde 0 değeri içeren gözlem birimleri eksik değeri
# ifade ediyor olabilir. Örneğin; bir kişinin glikoz veya insulin değeri 0
# olamayacaktır. Bu durumu dikkate alarak sıfır değerlerini ilgili değerlerde
